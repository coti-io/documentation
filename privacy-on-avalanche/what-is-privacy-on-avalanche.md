...
The SDK’s own [documentation README](https://github.com/coti-io/coti-sdk-pod/tree/main/site/README) states scope clearly: it does not replace deployment scripts, indexers, or backend services for you.
